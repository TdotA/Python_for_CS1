...
# Stack
#
# A (partial) implementation of the class Stack is alredy provided below
# (see the code). The stack is very similar to a list; this is why the
# constructor takes a list and stores it internally as an atribute called
# elements. 
# 
# Example:
#
...
#       it on the stack.
#
#  (ii) If the current charachter is ')', ']', or '}' then check the
